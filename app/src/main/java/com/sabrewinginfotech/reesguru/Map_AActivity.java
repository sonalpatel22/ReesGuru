...
import com.sabrewinginfotech.reesguru.adapter.AdapterUtil;
import com.sabrewinginfotech.reesguru.custom.RobotoTextView;
import com.sabrewinginfotech.reesguru.fragment.MySupportMapFragment;
...
public class Map_AActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<LocationSettingsResult>, LocationListener, GoogleMap.OnMarkerClickListener {
    ...
    private final static String TAG = Map_AActivity.class.getSimpleName();
    ...
    String[] mapplaces = {"airport", "restaurants", "hospitals", "shopping", "bus",
                "train", "schools", "atm", "park", "Gas station", "Worship", "grocery", "Bank"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = Map_AActivity.this;
        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        LinearLayoutManager manager = new LinearLayoutManager(this);
        manager.setOrientation(LinearLayoutManager.HORIZONTAL);
        recyclerView.setLayoutManager(manager);
        rvAdapter rvAdapter = new rvAdapter(Map_AActivity.this);
        recyclerView.setAdapter(rvAdapter);
        Intent i = getIntent();
        try {
            String[] latlang = i.getStringExtra("Latlang").split(",");
//            strLatitude = latlang[0];
            strLatitude = "21.19365498864821";

//            strLongitude = latlang[1];
            strLongitude = "72.8217601776123";
        } catch (Exception e) {
        ...
        customMapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                mMap = googleMap;
                mMap.setOnMarkerClickListener(Map_AActivity.this);
                if (ActivityCompat.checkSelfPermission(Map_AActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(Map_AActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            public void run() {
                                if (mapNearbyplacesModels != null) {
                                    if (!mapNearbyplacesModels.isEmpty()) {
                                        ...
                                        list_Adapter list_adapter = new list_Adapter(Map_AActivity.this, mapNearbyplacesModels);
...
//                MarkerOptions markerOptions = new MarkerOptions().position(latLng).title(placeName + " : " + vicinity).icon( bitmapDescriptorFromVector(context, R.drawable.ic_local_airport_black_24dp));
    ...
    public class list_Adapter extends BaseAdapter {
        ...
        public list_Adapter(Map_AActivity map_aActivity, ArrayList<MapNearbyplacesModel> mapNearbyplacesModels) {
